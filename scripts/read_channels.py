...
BVH_FILE = os.path.join(BASE_DIR, 'output2','segments_120','05_01_seg0.bvh') # can be changed as the above line, data from akob
...
with open(BVH_FILE, "r") as f:
    bvh = Bvh(f.read())
print("CHANNEL NUMBER = ", len(bvh.get_joints()))  
print("Number of features per frame = ", len(bvh.frames[0]))  # feature number each frames
...
'''
# save joint_channels list as JSON file
