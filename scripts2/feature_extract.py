...
BVH_DIR = os.path.join(BASE_DIR, 'output2', 'segments_100')
LABELS_PATH = os.path.join(BASE_DIR, 'output2', 'segment_labels_100.json')
OUTPUT_CSV = os.path.join(BASE_DIR, 'output2', 'features_100.csv')
